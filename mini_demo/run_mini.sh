...
# ---------- Ensure mini features exist (first-run only) ----------
if [ ! -f mini_demo/features/phoneme_level/metadata.txt ]; then
    echo "=== Mini preprocessing not found – running it now (10 files, ~10 seconds) ==="
