...
for parts in lines:
    ...
    data.append({
        ...
        'phonemes': phonemes,
        'pitch_sketch': f'mini_demo/features/human_sketches/{basename}_word_sketch.npy',
...
with open('mini_demo/inference_human_word.json', 'w') as f:
    json.dump({'data': data}, f, indent=2)

print('Created mini_demo/inference_human_word.json')
